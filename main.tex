...
\includegraphics[width=0.24\linewidth]{uproot-issues.pdf}\hfill\includegraphics[width=0.24\linewidth]{uproot-comments.pdf}\hfill\includegraphics[width=0.24\linewidth]{uproot-users.pdf}\hfill\includegraphics[width=0.24\linewidth]{uproot-response-time.pdf}
\end{columns}
\end{frame}
